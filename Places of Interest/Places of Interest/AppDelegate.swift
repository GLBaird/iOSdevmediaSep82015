...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var storyboard:UIStoryboard = {
        if UIDevice.currentDevice().userInterfaceIdiom == .Phone {
            return UIStoryboard(name: "iPhone", bundle: nil)
        } else {
            return UIStoryboard(name: "iPad", bundle: nil)
        }
    }()
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        do {
            ...
            if let rootVC = self.window?.rootViewController {
                ShowAlertWithTitle("Error loading core data",
                    message: "Please reinstall the app.\nReason:\(wrappedError.userInfo)",
                    button: "OK",
    ...
    func saveContext () {
        if managedObjectContext.hasChanges {
            do {
                ...
                if let rootVC = self.window?.rootViewController {
                    ShowAlertWithTitle("Failed to save core data context",
                        message: "Your data may be lost!\nReason: \(nserror.userInfo)",
                        button: "Cancel",
                        viewController: rootVC
                    )
                }
